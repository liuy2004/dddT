...
const VueElement = defineCustomElement({
  ...
  methods: {
    appendLog(content, type = INFO) {
      console.warn(content, content instanceof Object)
    ...
    queryRemindHandler() {
      return this.tcpApi.remindCommand(this.currentCommand)
    },
    nextRemind() {
    ...
    executeCommandHandler() {
      return this.tcpApi.execute(this.currentCommand)
    }
  },
  mounted() {
